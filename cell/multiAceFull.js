...
let refreshace = function() {
    ...
    for (let i = 0; i < alleditors.length; i++) {
        ...
        eval("let edt_" + i + " = ace.edit('editor_' + i)");
        eval("edit_" + i + ".setOptions('maxLines', 'Infinity')");
...
//document.addEventListener('DOMContentLoaded', refreshace);